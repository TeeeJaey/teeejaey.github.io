!(function (e) {
    function r(r) {
        for (var n, p, l = r[0], f = r[1], i = r[2], c = 0, s = []; c < l.length; c++)
    ...
    (p.m = e),
        ...
        (p.p = "/");
    var l = (this["webpackJsonpportfolio-app"] = this["webpackJsonpportfolio-app"] || []),
        f = l.push.bind(l);
    (l.push = r), (l = l.slice());
...
//# sourceMappingURL=runtime-main.c3e8af0c.js.map

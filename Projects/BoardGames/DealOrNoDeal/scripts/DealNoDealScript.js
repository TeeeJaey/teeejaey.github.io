...
function getAmtString(amt)
{
    ...
    if(amtString.length < 4)
        return rupeeSymbol + amtString;
    else
    {
        if(amtString.length < 7)
            ...
            return rupeeSymbol + amtString.substring(0, amtString.length-6) + ',' + amtString.substring(amtString.length-6, amtString.length-3) + ',' + amtString.substring(amtString.length - 3, amtString.length);
    }
}
